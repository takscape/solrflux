...
import net.moraleboost.solrql.eval.expr.AddExpression;
import net.moraleboost.solrql.eval.expr.AndExpression;
import net.moraleboost.solrql.eval.expr.BigDecimalLiteral;
import net.moraleboost.solrql.eval.expr.BigIntegerLiteral;
import net.moraleboost.solrql.eval.expr.BinaryOperatorExpression;
import net.moraleboost.solrql.eval.expr.BooleanLiteral;
import net.moraleboost.solrql.eval.expr.CallExpression;
import net.moraleboost.solrql.eval.expr.CompareExpression;
import net.moraleboost.solrql.eval.expr.DivideExpression;
import net.moraleboost.solrql.eval.expr.DoubleLiteral;
import net.moraleboost.solrql.eval.expr.EqualToExpression;
import net.moraleboost.solrql.eval.expr.FloatLiteral;
import net.moraleboost.solrql.eval.expr.IdLiteral;
import net.moraleboost.solrql.eval.expr.IndexExpression;
import net.moraleboost.solrql.eval.expr.IntegerLiteral;
import net.moraleboost.solrql.eval.expr.ListExpression;
import net.moraleboost.solrql.eval.expr.LongLiteral;
import net.moraleboost.solrql.eval.expr.MultiplyExpression;
import net.moraleboost.solrql.eval.expr.NegateExpression;
import net.moraleboost.solrql.eval.expr.NotEqualToExpression;
import net.moraleboost.solrql.eval.expr.NotExpression;
import net.moraleboost.solrql.eval.expr.NullLiteral;
import net.moraleboost.solrql.eval.expr.NumberLiteralExpression;
import net.moraleboost.solrql.eval.expr.OrExpression;
import net.moraleboost.solrql.eval.expr.StringLiteral;
import net.moraleboost.solrql.eval.expr.SubtractExpression;
import net.moraleboost.solrql.eval.expr.UnaryOperatorExpression;
import net.moraleboost.solrql.eval.expr.WildcardLiteral;
