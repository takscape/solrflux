...
import net.moraleboost.solrql.eval.expr.func.BigDecimalFunction;
import net.moraleboost.solrql.eval.expr.func.BigIntegerFunction;
import net.moraleboost.solrql.eval.expr.func.DateFunction;
import net.moraleboost.solrql.eval.expr.func.DoubleFunction;
import net.moraleboost.solrql.eval.expr.func.FloatFunction;
import net.moraleboost.solrql.eval.expr.func.IntegerFunction;
import net.moraleboost.solrql.eval.expr.func.LengthFunction;
import net.moraleboost.solrql.eval.expr.func.LongFunction;
import net.moraleboost.solrql.eval.expr.func.StringFunction;
import net.moraleboost.solrql.eval.expr.func.SubstringFunction;
